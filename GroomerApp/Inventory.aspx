<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" AutoEventWireup="true" CodeBehind="Inventory.aspx.cs" Inherits="GroomerApp.Inventory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <div class="innercontent inventory">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblFleaTick22" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblFleaTick44" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblFleaTick88" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblFleaTick132" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblFleaTickCat" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblToothbrushes" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblWham" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblTowels" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblTreats" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblCottonPads" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblCottonSwabs" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblVetWrap" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblPaperTowels" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblGarbageBags" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblReceipts" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblEnvelopes" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblBusinessCards" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblOther1" runat="server" CssClass="lbl"></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblOther2" runat="server" CssClass="lbl"></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblOther3" runat="server" CssClass="lbl"></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblOther4" runat="server" CssClass="lbl"></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblOther5" runat="server" CssClass="lbl"></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq1" runat="server" CssClass="lbl" Text=" "></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq2" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq3" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq4" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq5" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq6" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq7" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq8" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq9" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq10" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq11" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq12" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq13" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq14" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq15" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq16" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq17" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq18" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq19" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq20" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq21" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq22" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq23" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq24" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblliq25" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblMarketing1" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblMarketing2" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblMarketing3" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblMarketing4" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblMarketing5" runat="server" CssClass="lbl" Text=""></asp:Label>
            </div>
            <div class="divcell_right">
    ...
    <div class="innercontent">
        <div class="bottombtn">
            <asp:Button ID="btnLoad" runat="server" Text="Load" ToolTip="Load" CssClass="btn"
                OnClick="btnLoad_Click" />
            &nbsp;
            <asp:Button ID="btnSubmit" runat="server" Text="Submit" ToolTip="Submit" OnClientClick="return validate();"
                OnClick="btnSubmit_Click" CssClass="btn" />
