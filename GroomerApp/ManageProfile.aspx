<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" AutoEventWireup="true" CodeBehind="ManageProfile.aspx.cs" Inherits="GroomerApp.ManageProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <div class="innercontent">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblName" runat="server" CssClass="lbl">Name:</asp:Label>
            </div>
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblAddress" runat="server" CssClass="lbl">Address:</asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblBaseCity" runat="server" CssClass="lbl">Base City:</asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="Label1" runat="server" CssClass="lbl">State:</asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="Label2" runat="server" CssClass="lbl">Zipcode:</asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblHomePhone" runat="server" CssClass="lbl">Phone 1:</asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblPersonalCellPhone" runat="server" CssClass="lbl">Phone 2:</asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblEmailID" runat="server" CssClass="lbl">Email ID:</asp:Label>
            </div>
            <div class="divcell_right">
                <asp:TextBox ID="txtEmailID" runat="server" CssClass="txt txt117" MaxLength="20"></asp:TextBox>
                <br />
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="Label3" runat="server" CssClass="lbl">Time Zone:</asp:Label>
            </div>
            <div class="divcell_right">
    ...
    <div class="innercontent">
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblCurrentPassword" runat="server" CssClass="lbl">Current Password:</asp:Label>
            </div>
            <div class="divcell_right">
                ...
                <asp:RequiredFieldValidator ID="req1" runat="server" ErrorMessage="Please enter current password"
                    ControlToValidate="txtCurrentPassword" CssClass="error_msg" Display="Dynamic"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblNewPassword" runat="server" CssClass="lbl">New Password:</asp:Label>
            </div>
            <div class="divcell_right">
        ...
        <div class="divrow">
            <div class="divcell_left">
                <asp:Label ID="lblConfirmPassword" runat="server" CssClass="lbl">Confirm Password:</asp:Label>
            </div>
            <div class="divcell_right">
    ...
    <div class="innercontent">
        <div class="bottombtn">
            <asp:Button ID="btnUpdate" runat="server" Text="Update" Width="105" ToolTip="Update"
