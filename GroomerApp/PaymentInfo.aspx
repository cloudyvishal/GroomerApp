<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" AutoEventWireup="true" CodeBehind="PaymentInfo.aspx.cs" Inherits="GroomerApp.PaymentInfo" %>
        ...
        <tr>
            <td>
                <table align="center" style="width: 100%">
                    ...
                    <tr>
                        <td align="center">
                            <asp:Label ID="lblString" runat="server" Text="String:" CssClass="appnt_lbl"></asp:Label>
                        </td>
                        <td align="left">
                ...
                <table class="payment_page" width="100%" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtCountry" runat="server" CssClass="txt txt117" AutoCompleteType="Disabled"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" colspan="2">
                ...
                <table align="center" style="width: 100%">
                    ...
                    <tr>
                        <td align="center">
                            <asp:Button ID="btnSubmitInfo" runat="server" CssClass="btn_New" Text="Submit Payment"
                                OnClick="btnSubmitInfo_Click" ValidationGroup="Payment_Validation" />
                            &nbsp;
                            <asp:Button ID="btneditapt" Text="Edit Appointment" runat="server" CssClass="btn_New"
                                OnClick="btneditapt_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
