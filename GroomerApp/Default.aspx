<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GroomerApp._Default" %>
                                                            ...
                                                            <div class="logindiv">
                                                                ...
                                                                <div class="divrow">
                                                                    <div class="divcell_left">
                                                                        <asp:Label ID="lblUsername" runat="server" CssClass="lbl">Username:</asp:Label></div>
                                                                    <div class="divcell_right">
                                                                        <asp:TextBox ID="txtUsername" runat="server" CssClass="txt150" MaxLength="50"></asp:TextBox></div>
                                                                </div>
                                                                <div class="divrow">
                                                                    <div class="divcell_left">
                                                                        <asp:Label ID="lblPassword" runat="server" CssClass="lbl">Password:</asp:Label></div>
                                                                    <div class="divcell_right">
                                                                        <asp:TextBox ID="txtPassword" runat="server"
                                                                            CssClass="txt150" MaxLength="20" TextMode="Password"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                <div class="divrow">
                                                                    ...
                                                                    <div class="divcell_right">
                                                                        <asp:Button ID="btnSignin" runat="server" Text="Sign in"
                                                                            ToolTip="Sign in" AccessKey="1" CssClass="btn"
